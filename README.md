...
![Меню](https://github.com/daretodream666/Software_Engineering/blob/Tema_9/pics/lab1.png)

### Выводы

Сделали класс, поиграли в угадайку
...
![Меню](https://github.com/daretodream666/Software_Engineering/blob/Tema_9/pics/lab2.png)

### Выводы

Блин, хочу мороженое, а у меня горло болит уже недели две. Какое-нибудь вкусное.
...
![Меню](https://github.com/daretodream666/Software_Engineering/blob/Tema_9/pics/lab3.png)

### Выводы

А, так ошибка выводится потому что пытаемся получить значение, которое уже удалено.

## 4 Вам прекрасно известно, что кошки и собаки являются млекопитающими, но компьютер этого не понимает, поэтому вам нужно написать три класса: Кошки, Собаки, Млекопитающие. И при помощи “наследования” объяснить компьютеру что кошки и собаки – это млекопитающие. Также добавьте какой-нибудь свой атрибут для кошек и собак, чтобы показать, что они чем-то отличаются друг от друга.

![Меню](https://github.com/daretodream666/Software_Engineering/blob/Tema_9/pics/lab4.png)

### Выводы

Собачки и кошечки млекопитающие
...
![Меню](https://github.com/daretodream666/Software_Engineering/blob/Tema_9/pics/lab5.png)

### Выводы

Статикметоды прикольно, им не передаётся self.
...
Продолжайте ухаживать за нимиМихаил А. Панов
5) Соберите урожай
Результатом работы вашей программы будет листинг кода с подробными
комментариями и скриншоты выполенния всех тестов.

![Меню](https://github.com/daretodream666/Software_Engineering/blob/Tema_9/pics/sam1.png)
![Меню](https://github.com/daretodream666/Software_Engineering/blob/Tema_9/pics/sam2.png)
...
Короче продолжаем ООП жеска делать, на самом деле оч важная тема, потому что я её немного пропустил мимо себя.